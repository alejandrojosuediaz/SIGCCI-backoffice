...
export interface ApiDenominacionDenominacion
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Denominacion: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiEmpresaEmpresa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ActividadEmpresarial: Schema.Attribute.Text & Schema.Attribute.Required;
    Activo: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    CapitalMaximo: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    Clasificacion: Schema.Attribute.Enumeration<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CuotaMensual: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
        number
      >;
    denominacion: Schema.Attribute.Relation<
      'oneToOne',
      'api::denominacion.denominacion'
    > &
      Schema.Attribute.Required;
    Direccion: Schema.Attribute.Text & Schema.Attribute.Required;
    Encargado: Schema.Attribute.String;
    FechaConstitucion: Schema.Attribute.Date;
    FechaMercantil: Schema.Attribute.Date;
    filial: Schema.Attribute.Relation<'oneToOne', 'api::filial.filial'> &
      Schema.Attribute.Required;
    ...
    LugarDeclaracion: Schema.Attribute.String;
    ...
    NombreRepresentante: Schema.Attribute.String & Schema.Attribute.Required;
    NombreSocios: Schema.Attribute.Text;
    NombreSubgerente: Schema.Attribute.String;
    NumeroEmpleados: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    NumeroEscritura: Schema.Attribute.String;
    NumeroRegistro: Schema.Attribute.String & Schema.Attribute.Required;
    PagoAfiliacion: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    ramas: Schema.Attribute.Relation<'oneToMany', 'api::rama.rama'> &
      Schema.Attribute.Required;
    RegistroMercantil: Schema.Attribute.Integer;
    ...
    sector_desempenos: Schema.Attribute.Relation<
      'oneToMany',
      'api::sector-desempeno.sector-desempeno'
    > &
      Schema.Attribute.Required;
    slug: Schema.Attribute.UID<'NombreEmpresa'> & Schema.Attribute.Required;
    TelefonoFax: Schema.Attribute.String;
    tipo_tramite: Schema.Attribute.Relation<
      'oneToOne',
    ...
    TomoMercantil: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFilialFilial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Abreviatura: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    CodigoRegion: Schema.Attribute.String &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 4;
        minLength: 4;
    ...
    CorreosElectronicos: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Direccion: Schema.Attribute.Text;
    Director: Schema.Attribute.String;
    Filial: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::filial.filial'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    UsarCamara: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    Website: Schema.Attribute.String;
  };
...
export interface ApiNoticiaNoticia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Cuerpo: Schema.Attribute.Blocks & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    Mostrar: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'TituloPrincipal'> & Schema.Attribute.Required;
    TituloPrincipal: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPerfilOrganizacionalPerfilOrganizacional
  extends Struct.SingleTypeSchema {
  collectionName: 'perfil_organizacionals';
  info: {
    displayName: 'Perfil organizacional';
    pluralName: 'perfil-organizacionals';
    singularName: 'perfil-organizacional';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::perfil-organizacional.perfil-organizacional'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgramaPrograma extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Programa: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRamaRama extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::rama.rama'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rama: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSitiosWebSitiosWeb extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'sitios-webs';
    singularName: 'sitios-web';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiTipoTramiteTipoTramite extends Struct.CollectionTypeSchema {
  collectionName: 'tipo_tramites';
  info: {
    description: 'Tipos de tr\u00E1mites disponibles en el sistema';
...
export interface PluginVisualTagsContentConfig
  extends Struct.CollectionTypeSchema {
  collectionName: 'visual_tags_configs';
  info: {
    displayName: 'Visual Tags Configuration';
    pluralName: 'configs';
    singularName: 'config';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::visual-tags-content.config'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::perfil-organizacional.perfil-organizacional': ApiPerfilOrganizacionalPerfilOrganizacional;
      ...
      'api::sitios-web.sitios-web': ApiSitiosWebSitiosWeb;
      ...
      'plugin::visual-tags-content.config': PluginVisualTagsContentConfig;
    }
  }
}
