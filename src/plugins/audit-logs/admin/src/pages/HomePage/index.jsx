                  ...
                  <Flex direction="column" alignItems="stretch" gap={3}>
                    ...
                    {(selectedLog.payload || selectedLog.data) && (
                      <Box>
                        ...
                        {(() => {
                          const payload = selectedLog.payload || selectedLog.data || {};
                          const payloadData = payload.data || payload;

                          const changeRows =
                            payloadData &&
                              typeof payloadData === "object" &&
                              Array.isArray(payloadData.changedFields)
                              ? payloadData.changedFields
                              : [];
                              ...
                              {rows.length > 0 && (
                                ...
                                >
                                  <Table colCount={3} rowCount={rows.length + 1}>
                                    ...
                                    <Tbody>
                                      {rows.map((row) => (
                                        <Tr key={row.field || `${row.oldValue}-${row.newValue}`}>
                                          <Td>
